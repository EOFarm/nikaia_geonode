...
echo "-----------------------------------------------------"
echo "STARTING geonode_nikaia RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./geonode_nikaia/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED geonode_nikaia RESTORE $(date)"
echo "-----------------------------------------------------"
